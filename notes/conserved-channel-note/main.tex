...
$\lambda$, the known large-interaction-order observation that the
bilinear-tower couplings first appear at second order in the inverse
body count --- $O(1/p^2)$ in the present conventions (written
$O(1/q^2)$ in \cite{GR}, whose $q$ is this note's $p$, not the chord
parameter).
\end{corollary}
